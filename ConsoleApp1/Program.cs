internal class Program
{
    public static void Main(string[] args)
    {
        ...
        string excuseRussell = "Bill Russell was a civil rights legend but if we being real he played with 12 hall of famers at a time where there was like 8 teams in the leauge. \n11 Rings in 13 years is crazy though\nAlso never even average 19 points per game LMAO";
